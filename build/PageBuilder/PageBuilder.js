...
var PageBuilder = /** @class */ (function () {
    ...
    PageBuilder.createPosts = function (postTitles) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!!postTitles.length) return [3 /*break*/, 3];
                    return [4 /*yield*/, PageBuilder.getDBnames()];
                case 1:
                    titles = _b.sent();
                    return [4 /*yield*/, Promise.all(titles.map(function (post) {
                            return Post_1.Post.create(post);
                        }))];
                case 2: return [2 /*return*/, _b.sent()];
                case 3: return [4 /*yield*/, Promise.all(postTitles.map(function (post) {
                        return Post_1.Post.create(post);
                    }))];
    ...
    PageBuilder.getDBnames = function () { return __awaiter(void 0, void 0, void 0, function () {
        var files;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, FS_1.FS.readdir('./build/db')];
                case 1:
                    files = _b.sent();
    ...
    PageBuilder.getPostNames = function () { return __awaiter(void 0, void 0, void 0, function () {
        var files;
        return __generator(_a, function (_b) {
            switch (_b.label) {
